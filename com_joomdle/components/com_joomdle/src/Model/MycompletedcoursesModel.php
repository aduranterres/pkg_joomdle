...
class MycompletedcoursesModel extends ListModel
{
    ...
    public function getCourses($data)
    {
        ...
        if (!array_key_exists('group_by_category', $data)) {
        ...
        if ((array_key_exists('courses_not_shown', $data)) && ($data['courses_not_shown'])) {
            $items = ContentHelper::excludeByValue($items, 'id', $data['courses_not_shown']);
        }
        if ((array_key_exists('categories_shown', $data)) && ($data['categories_shown'])) {
            $items = ContentHelper::filterByValue($items, 'category', $data['categories_shown']);
        }
        if ((array_key_exists('categories_not_shown', $data)) && ($data['categories_not_shown'])) {
