...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        if ($params->get('mailing_list_integration') == 'no') {
            ToolbarHelper::title(Text::_('COM_JOOMDLE_TITLE_MAILINGLIST'), 'mailinglist');
            $this->message = Text::_('COM_JOOMDLE_MAILING_LIST_INTEGRATION_NOT_ENABLED');
            parent::display($tpl);
            return;
        }
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title(Text::_('COM_JOOMDLE_TITLE_MAILINGLIST'), "envelope inbox");
