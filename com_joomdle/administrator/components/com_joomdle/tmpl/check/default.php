...
<?php if (!empty($this->sidebar)) : ?>
    ...
    <?php else : ?>
        ...
        <br>
        <center><?php echo Text::_('COM_JOOMDLE_FOR_PROBLEM_RESOLUTION_SEE'); ?>: <a target='_blank' href="https://www.joomdle.com/docs/installation/check">https://www.joomdle.com/docs/installation/check</a></center>
        </div>
